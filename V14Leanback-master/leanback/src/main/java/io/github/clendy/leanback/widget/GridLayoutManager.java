...
//        if (TRACE) TraceHelper.endSection();
    ...
    /**
     *  offsetTopAndBottom 与 offsetLeftAndRight
     *  是滑动的一种方式.
     * @param increment
     */
...
//            if (TRACE) TraceHelper.endSection();
        ...
        Log.d("hailongqiu", "scrollDirectionPrimary mScrollOffsetPrimary:" + mScrollOffsetPrimary);
        mScrollOffsetPrimary += da;
        Log.d("hailongqiu", "scrollDirectionPrimary mScrollOffsetPrimary222:" + mScrollOffsetPrimary);
        if (mInLayout) {
//            if (TRACE) TraceHelper.endSection();
            return da;
        }
...
//        if (TRACE) TraceHelper.endSection();
    ...
    private int scrollDirectionSecondary(int dy) {
        ...
        Log.d("hailongqiu", "scrollDirectionSecondary dy:" + dy);
        mBaseGridView.invalidate();
        return dy;
    }
    ...
    private void initScrollController() {
        ...
        Log.d("hailongqiu", "initScrollController mScrollOffsetPrimary:" + mScrollOffsetPrimary);
...
//        Log.d("hailongqiu", "updateScrollController mScrollOffsetPrimary22:" + mScrollOffsetPrimary);
        mWindowAlignment.horizontal.setSize(getWidth());
        mWindowAlignment.vertical.setSize(getHeight());
        mWindowAlignment.horizontal.setPadding(getPaddingLeft(), getPaddingRight());
        mWindowAlignment.vertical.setPadding(getPaddingTop(), getPaddingBottom());
...
//        if (TRACE) TraceHelper.endSection();
    ...
    private int getAdjustedPrimaryScrollPosition(int scrollPrimary, View view, View childView) {
        ...
        if (subindex != 0) {
            final LayoutParams lp = (LayoutParams) view.getLayoutParams();
            int n = lp.getAlignMultiple()[subindex];
    ...
    private boolean getAlignedPosition(View view, View childView, int[] deltas) {
        ...
        Log.d("hailongqiu", "getAlignedPosition mScrollOffsetPrimary:" + mScrollOffsetPrimary);
        scrollPrimary -= mScrollOffsetPrimary; // 这个这么来的.
        scrollSecondary -= mScrollOffsetSecondary;
