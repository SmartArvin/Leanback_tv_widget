...
public final class TransitionHelper {
        ...
        public void runTransition(Object scene, Object transition) {
            ...
            if (transitionStub != null && transitionStub.mTransitionListeners != null) {
                for (int i = 0, size = transitionStub.mTransitionListeners.size(); i < size; i++) {
                    transitionStub.mTransitionListeners.get(i).onTransitionStart((Transition) transition);
                }
            }
            ...
            if (transitionStub != null && transitionStub.mTransitionListeners != null) {
                for (int i = 0, size = transitionStub.mTransitionListeners.size(); i < size; i++) {
                    transitionStub.mTransitionListeners.get(i).onTransitionEnd((Transition) transition);
                }
            }
        }
    ...
    static class TransitionHelperKitkatImpl extends TransitionHelperStubImpl {
        ...
        @Override
        public Object createScene(ViewGroup sceneRoot, Runnable r) {
            return null ;//TransitionHelperKitkat.createScene(sceneRoot, r);
        }

        @Override
        public Object createAutoTransition() {
            return null;//TransitionHelperKitkat.createAutoTransition();
        }

        @Override
        public Object createFadeTransition(int fadingMode) {
            return null;//TransitionHelperKitkat.createFadeTransition(fadingMode);
        }

        @Override
        public Object createChangeBounds(boolean reparent) {
            return null;//TransitionHelperKitkat.createChangeBounds(reparent);
        }

        @Override
        public Object createSlide(int slideEdge) {
            return null;//TransitionHelperKitkat.createSlide(slideEdge);
        }

        @Override
        public Object createScale() {
            return null;//TransitionHelperKitkat.createScale();
        }
...
//            TransitionHelperKitkat.setChangeBoundsDefaultStartDelay(changeBounds, startDelay);
        ...
        @Override
        public Object createTransitionSet(boolean sequential) {
            return null;//TransitionHelperKitkat.createTransitionSet(sequential);
        }
...
//            TransitionHelperKitkat.addTarget(transition, view);
        ...
        @Override
        public Object loadTransition(Context context, int resId) {
            return null;//TransitionHelperKitkat.loadTransition(context, resId);
        }
    }
...
//            TransitionHelperApi21.addSharedElement(ft, view, transitionName);
        ...
        @Override
        public Object getSharedElementEnterTransition(Window window) {
            return null; //TransitionHelperApi21.getSharedElementEnterTransition(window);
        }

        @Override
        public Object getSharedElementReturnTransition(Window window) {
            return null; //TransitionHelperApi21.getSharedElementReturnTransition(window);
        }

        @Override
        public Object getSharedElementExitTransition(Window window) {
            return null;//TransitionHelperApi21.getSharedElementExitTransition(window);
        }

        @Override
        public Object getSharedElementReenterTransition(Window window) {
            return null;//TransitionHelperApi21.getSharedElementReenterTransition(window);
        }

        @Override
        public Object createFadeAndShortSlide(int edge) {
            return null;//TransitionHelperApi21.createFadeAndShortSlide(edge);
        }

        @Override
        public Object createFadeAndShortSlide(int edge, float distance) {
            return null;//TransitionHelperApi21.createFadeAndShortSlide(edge, distance);
        }
...
//            TransitionHelperApi21.beginDelayedTransition(sceneRoot, transition);
        ...
        @Override
        public Object getEnterTransition(Window window) {
            return null;//TransitionHelperApi21.getEnterTransition(window);
        }

        @Override
        public Object getReturnTransition(Window window) {
            return null; //TransitionHelperApi21.getReturnTransition(window);
        }

        @Override
        public Object getExitTransition(Window window) {
            return null; //TransitionHelperApi21.getExitTransition(window);
        }

        @Override
        public Object getReenterTransition(Window window) {
            return null; //TransitionHelperApi21.getReenterTransition(window);
        }

        @Override
        public Object createScale() {
            return null;//TransitionHelperApi21.createScale();
        }

        @Override
        public Object createDefaultInterpolator(Context context) {
            return null;//TransitionHelperApi21.createDefaultInterpolator(context);
        }
        ...
        @Override
        public Object createChangeTransform() {
            return null;//TransitionHelperApi21.createChangeTransform();
        }
