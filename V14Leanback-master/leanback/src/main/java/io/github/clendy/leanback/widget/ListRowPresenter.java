    ...
    public static class SelectItemViewHolderTask extends Presenter.ViewHolderTask {
        ...
        public void run(Presenter.ViewHolder holder) {
            if (holder instanceof ViewHolder) {
                ...
                io.github.clendy.leanback.widget.ViewHolderTask task = null;
                if (mItemTask != null) {
                    task = new io.github.clendy.leanback.widget.ViewHolderTask() {
...
//    }
    ...
    protected void initializeRowViewHolder(RowPresenter.ViewHolder holder) {
        ...
        // HorizontalGridView item 选中事件.
        rowViewHolder.mGridView.setOnChildSelectedListener(
                new OnChildSelectedListener() {
            @Override
            public void onChildSelected(ViewGroup parent, View view, int position, long id) {
                Log.d("hailongqiu", "hailongqiu position:" + position);
...
//        rowViewHolder.mGridView.setOnChildViewHolderSelectedListener 选中一行的监听事件.
    }
    ...
    /**
     *  重写这个函数，可以使用其它布局.
     *  不一定是 ListRowView 带 HorizontalGridView 的控件.
     *  可以参考 InvisibleRowPresenter.java.
     */
    @Override
    ...
    protected void onBindRowViewHolder(RowPresenter.ViewHolder holder, Object item) {
        ...
        // 设置HorizontalGridView的数据.
        ViewHolder vh = (ViewHolder) holder;
        ListRow rowItem = (ListRow) item;
        vh.mItemBridgeAdapter.setAdapter(rowItem.getAdapter()); // 适配数据.
